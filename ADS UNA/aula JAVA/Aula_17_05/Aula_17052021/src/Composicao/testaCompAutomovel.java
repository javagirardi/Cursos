...
public class testaCompAutomovel {
	...
	public static void leDados(Automovel [] carro) {
		...
		for(int i=0; i<carro.length; i++) {
			...
			//i-ésima instância do objeto Automovel
			//As partes pertencem a um todo - COMPOSIÇÃO
			carro[i] = new Automovel(pot, chassi, combustivel, fabricante, cor, tamanhoRaio, kitMultimidia); 
